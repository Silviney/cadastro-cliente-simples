package com.silviney.cadastro_cliente_simples.resources;
...
import com.silviney.cadastro_cliente_simples.services.UsuarioService;
...
public class UsuarioResource {
	...
	public ResponseEntity<Usuario> update(@PathVariable Integer id, @RequestBody Usuario obj){
		Usuario newObj = service.uptade(id,obj);
